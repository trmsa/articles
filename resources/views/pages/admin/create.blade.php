            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="major" class="col-md-2 col-form-label text-md-start">رشته مورد نظر</label>
                            <div class="col-md-10">

                                <select class="form-select form-select-lg" name="major" id="major"
                                    @error('major') is-invalid @enderror>
                                    <option value="کیهان شناسی">کیهان شناسی</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input id="albom" type="file" class="form-control @error('albom') is-invalid @enderror"
                                    name="albom[]" value="{{ old('albom') }}" autocomplete="albom" autofocus>
