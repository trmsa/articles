...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'data-graduation'       => 'تاریخ فارغ التحصیلی',
        'data_graduation'       => 'تاریخ فارغ التحصیلی',
        'date-birth'            => 'تاریخ تولد',
        'img-degree'            => 'تصویر مدرک تحصیلی',
        'img_degree'            => 'تصویر مدرک تحصیلی',
        'email'                 => 'ایمیل',
        'first_name'            => 'نام',
        ...
        'abstract'              => 'خلاصه',
        'body'                  => 'متن',
        'indicator-img'         => 'تصویر شاخص',
        'indicator_img'         => 'تصویر شاخص',
        'end'                   => 'پایان',
        'tel_manag'             => 'تلفن مدیریت',
        'tel_public'            => 'تلفن روابط عمومی',
        'tel_deputy'            => 'تلفن معاونت',
        'postal_code'           => 'کدپستی',
    ],
